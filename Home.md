...
* [Show User Info](https://github.coventry.ac.uk/thorntonj/13764108_CW/wiki/Show-User-Info)
* [List Users](https://github.coventry.ac.uk/thorntonj/13764108_CW/wiki/List-Users)
* [List Running Processes](https://github.coventry.ac.uk/thorntonj/13764108_CW/wiki/List-Running-Processes)
* [Scan Ports](https://github.coventry.ac.uk/thorntonj/13764108_CW/wiki/Scan-Ports)
> On top of all info covered in each page, each enumeration function also creates a CSV file only containing the information gathered by that function

> Every function works on both Windows and Unix
